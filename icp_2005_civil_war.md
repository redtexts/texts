...
The southerners were quick to oppose the movement, known as _free-soilism_, which consisted, in any case, mainly of people from the North-East. The North, meanwhile, in the fifties, had no reason to oppose it. There was therefore a notable slackening of that strong bond which had united the farmers of the South and West over the previous ten years: the consequence of this separation, which also had repercussions on the Democratic Party, and which effectively turned the South into a foreign body within the Union, would soon be felt.
